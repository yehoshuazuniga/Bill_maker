...
class PDFAproved extends FPDF
{
    ...
    protected $operador;
    protected $documento;
    protected $idPresupuesto;
    function __construct($empresa, $cliente, $operacion, $operador, $tipoDoc, $idPresu)
    {
        $this->datosEmpresa = $empresa;
        $this->datosCliente = $cliente;
        $this->datosOperacion = $operacion;
    ...
    function Header()
    {
        ...
        $this->Ln(8);
        $this->Cell(95, 8, utf8_decode(' Atendido por: ' . $this->operador));
        $this->Cell(95, 8, utf8_decode(' Nº de Fatura: ' . array_shift($this->datosOperacion)));
        $this->Ln(8);
        $this->Cell(95, 8, utf8_decode(' Fecha de creacion: ' . array_shift($this->datosOperacion)));
        $this->Cell(95, 8, utf8_decode(' Presupuesto origen: '.$this->idPresupuesto ));
        $this->Ln(15);
    }
